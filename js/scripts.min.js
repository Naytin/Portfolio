...
$(document).ready(function () {
  ...
  function t(e) {
    return u.eq(e).find("> a").attr("href")
  }
  ...
  $("#my-menu").mmenu({
    extensions: ["theme-black", "effect-menu-slide", "pagedim-black", "fx-listitems-slide", "border-offset"],
    navbar: {
      title: "Nikitina Mariya"
    }
  }), $("#my-menu").data("mmenu").bind("open:start", function () {
    $(".hamburger").addClass("is-active")
  }).bind("close:finish", function () {
    $(".hamburger").removeClass("is-active")
  }), $("#my-menu").on("click", "a", function (e) {
    e.preventDefault();
    var t = $(this).attr("href"),
      i = $(t).offset().top;
    $("body,html").delay(1e3).animate({
      scrollTop: i
    }, 500)
  });
  ...
  for (var g, m, u = $(".g-wrapper").find(".slick-item"), h = u.find("> a"), d = $(".lightbox"), 
  p = $(".next"), v = $(".prev"), b = $(".overlay"), y = [], k = [], w = 0; w < y.length; w++) k[w] = new Image, k[w].src = y[w];
  b.click(function () {
    d.fadeOut()
  }), h.click(function (t) {
    t.preventDefault(), m = $(this).attr("href"), g = $(this).parent().index(), e(m), d.fadeIn()
  }), p.click(function () {
    g + 1 < u.length ? (m = t(g + 1), g++) : (m = t(0), g = 0), e(m)
  }), v.click(function () {
    g > 0 ? (m = t(g - 1), g--) : (m = t(u.length - 1), g = u.length - 1), e(m)
  });
